      ...
      <Row>
        <Col xs={12} md={12} lg={3}>
          <aside className="rounded p-3 aside-bg text-secondary ">
            ...
            <p>
              <NavLink className="link-style" to="/addPost">
                Create Post
              </NavLink>
            </p>
            <p>
              <NavLink className="link-style" to="/addProduct">
                Add Product
              </NavLink>
            </p>
            <p>
            ...
            <p>
              <NavLink className="link-style" to="/manageProducts">
                Manage Products
              </NavLink>
            </p>
            <p>
              <NavLink className="link-style" to="/managePosts">
                Manage Posts
              </NavLink>
            </p>
            <p>
              <NavLink className="link-style" to="/manageAllOrders">
                Manage Orders
              </NavLink>
            </p>
            ...
            <p>
              <NavLink className="link-style" to="/privacyPolicy">
                Privacy Policy
              </NavLink>
            </p>
            <p>
            ...
            <p>
              <NavLink className="link-style" to="/termsOfUse">
                Terms & Condition
              </NavLink>
            </p>
            <p>
              <NavLink className="link-style" to="/sponsors">
                Sponsors
              </NavLink>
            </p>
            <p>
