    ...
    <Container>
      <section>
        ...
        <div className="images d-lg-flex text-center">
          <Figure>
            <Figure.Image width={171} height={180} alt="171x180" src={emon} />
            <Figure.Caption>Emon Ahmed</Figure.Caption>
          </Figure>
          <Figure>
            <Figure.Image width={171} height={180} alt="171x180" src={sohag} />
          ...
          <Figure>
            <Figure.Image width={171} height={180} alt="171x180" src={aman} />
            <Figure.Caption>Md. Amanullah Parvez</Figure.Caption>
          </Figure>
        </div>
      </section>
      <p>
        This a blog website where we love writting about web development. Latest
        technologies and updates are our primary focus along with critical
        issues and basics of Web Development.
      </p>
